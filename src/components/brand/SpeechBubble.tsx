...
const SpeechBubble = ({ children, speaker, className = '' }: SpeechBubbleProps) => (
  <div className={`relative ${className}`}>
    <div className="afl-glow relative rounded-[999px] border-[3px] border-[var(--afl-white)] bg-[var(--afl-white)] px-6 py-5 md:px-9 md:py-6">
      {speaker ? (
    ...
    <span
      aria-hidden="true"
      className="absolute -bottom-[14px] left-12 block h-0 w-0 border-l-[14px] border-r-[14px] border-t-[16px] border-l-transparent border-r-transparent border-t-[var(--afl-white)]"
    />
  </div>
)
